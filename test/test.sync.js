...
describe( 'sync', function tests() {
	...
	it( 'should read a Human JSON file', function test() {
		var actual = read( file );
		assert.deepEqual( actual, data );
	});

	it( 'should read a Human JSON file using provided options', function test() {
		var actual;
	...
	it( 'should return an error if unable to parse file data as Human JSON', function test() {
		var out = read( bad );
		assert.isTrue( out instanceof Error );
	});
